...
<footer>
        ...
        >
            ...
            <div class="space-y-2 sm:col-span-6 md:col-span-3 lg:col-span-2">
                ...
                <ul class="flex gap-1">
                    <li>
                        <a
                            class="flex items-center justify-center text-blue-500 transition hover:text-blue-600"
                            href="#0"
                            aria-label="Twitter"
                        >
                            <svg
    ...
    <div class="relative -mt-16 h-60 w-full" aria-hidden="true">
        ...
        <!-- Glow -->
        <div
            class="absolute bottom-0 left-1/2 -translate-x-1/2 translate-y-2/3"
            aria-hidden="true"
        >
            <div
                class="h-56 w-56 rounded-full border-[20px] border-blue-700 blur-[80px]"
            ></div>
        </div>
    </div>
</footer>
